...
export const routePermissions: Record<string, Permission> = {
  ...
  "/risk-intelligence-center": PERMISSIONS.VIEW_RISK_INTELLIGENCE,
  "/alerts-patterns": PERMISSIONS.VIEW_ALERTS,
  "/crime-trend-hotspot": PERMISSIONS.VIEW_HOTSPOT_MAP,
  "/reports-briefing": PERMISSIONS.EXPORT_REPORTS,
